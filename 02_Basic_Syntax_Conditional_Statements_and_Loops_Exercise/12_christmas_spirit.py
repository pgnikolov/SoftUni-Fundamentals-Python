...
# •	days_to_cristmas – integer in range [1…100]
...
for day in range(1, days_to_cristmas + 1):
    if day % 11 == 0:
        quantity += 2
    if day % 2 == 0:
        ...
        total_spirits += 5
    if day % 3 == 0:
        budget -= TREE_GARLANDS_PRICE * quantity + TREE_SKIRT_PRICE * quantity
        total_spirits += 13
    if day % 5 == 0:
    ...
    if day % 10 == 0:
        total_spirits -= 20
        budget -= TREE_SKIRT_PRICE + TREE_LIGHTS_PRICE + TREE_GARLANDS_PRICE

if days_to_cristmas % 10 == 0:
    total_spirits -= 30
